<script lang="ts">
    ...
    let datetime_start_str: string = DateTime.now()
        .set({ hour: hour_start, minute: minute_start })
        .toFormat("yyyy-MM-dd'T'HH:mm");
    let datetime_end_str: string = DateTime.now()
        .set({ hour: hour_end, minute: minute_end })
        .toFormat("yyyy-MM-dd'T'HH:mm");
